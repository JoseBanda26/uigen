                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const args = tool.args as { path?: string; command?: string };
                            const filename = args.path ? args.path.split("/").pop() : undefined;
                            const toolVerbs: Record<string, string> = {
                              str_replace_editor: "Editing",
                              file_manager: "Managing",
                            };
                            const verb = toolVerbs[tool.toolName] ?? tool.toolName;
                            const label = filename ? `${verb} ${filename}` : verb;
                            return (
